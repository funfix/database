 ...
 * Matches the original Scala implementation structure exactly.
 *
 * ## Java Usage
 *
 * ```java
...
constructor(
    ...
    public companion object {
        /**
         * Creates a default configuration for the given database and queue name.
         *
         * @param db JDBC connection configuration
         ...
         */
        @JvmStatic
        public fun create(db: JdbcConnectionConfig, queueName: String): DelayedQueueJDBCConfig =
